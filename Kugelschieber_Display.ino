/* Servosteuerung für Kugelschieber Display Version vom 6.11.2025 Bernhard pleschko (Basierend auf sketch von Tillo!)
...
Servo ksServo; // servo Objekt erstellen um Motor zu steuern
...
void open1ButtonHandler(Button2 &open1Button)
{
  ...
  {                       // Bewegung des servo von 90 Grad bis 0 Grad in Schritten von 1 Grad
    ksServo.write(pos); // bewegt den servo zur aktuell festgelegten Position
...
void setup()
{
  ...
  ksServo.setPeriodHertz(50);           // standard 50 hz servo frequenz
  ksServo.attach(servoPin1, 544, 2400); // verbindet und aktiviert den Servo an servoPin1 zum servo objekt 1 mit pulse width min 544us und max 2400us
  ksServo.write(0);                   // Anfangshaltepunkt im offenen Zustand
  delay(2000);
